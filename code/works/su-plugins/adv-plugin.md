...
![](https://p.qlogo.cn/zc_icon/0/811a03d4383b5c9eb33f87e62f7faddc16275505939093/0.png "效果图")

# 视频演示

<iframe src="//player.bilibili.com/player.html?aid=285646304&bvid=BV1uf4y1U7Tx&cid=192662498&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="" style="width:100%;"> </iframe>
<script type="text/javascript">   
function __mashiros_bili_height_auto() {  var iframe = document.getElementsByTagName("iframe");        var num = iframe.length;        for (; num > 0; num--) {            iframe[num - 1].style.height = iframe[num - 1].scrollWidth * 0.75 + "px";}}
window.addEventListener('resize', __mashiros_bili_height_auto);
window.addEventListener('load', __mashiros_bili_height_auto);
</script>
